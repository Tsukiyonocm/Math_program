...
------------
0.085 - I have started adding in the custom mode feature which has proven to be quit problematic for me. I currently have it regenerating problems for basic addition, non strict right now. I am working on the code in order to get strict working. Once I have math done, then I shall move onto subtraction which once complete will likely be quit easy to get division and multiplication added afterwards. I will eventually need to reformat the code I am thinking as well. I am just trying to get things working now and not worrying to much about specificity in my functions. 
